...
def main():
    ...
    #     max_epochs=50
    # )
    # print("Best config from Ray Tune:", best_config)
    # print("Best RMSE from Ray Tune:", best_rmse)
    ...
    #     lr=best_config["lr"],
    # )
    # print("Cross-validation done. Average RMSE:", avg_rmse)
    ...
    print("Seaved submission at", submission_path)
...
if __name__ == "__main__":
    ...
    # print("Submission file saved at:", root)
